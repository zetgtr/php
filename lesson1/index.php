...
$textH1 = "Привет";
$textColor = "read more";
$footerHtml = '<p>Copyright &copy; <em>minimalistica</em> &middot; Design: Luka Cvrk, <a href="http://www.solucija.com/" title="Free CSS Templates">Solucija</a></p>';

// дз 2 - не стал делать новый фаил. мы с ВАМИ это уже делали на js)
$a = 10;
$b = 20;
$a = $a + $b;
$b = $a - $b;
...
<body>
	<div id="content">
		...
		<div class="col">
			...
			<p>&not; <a href="#"><? echo $textColor ?></a></p>
		</div>
		<div class="col">
